    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="books/b1.webp" class="d-block w-100" alt="Image 1">
            </div>
            <div class="carousel-item">
                <img src="books/b3.webp" class="d-block w-100" alt="Image 2">
            </div>
            <div class="carousel-item">
                <img src="books/b2.webp" class="d-block w-100" alt="Image 3">
            </div>
            <div class="carousel-item">
                <img src="books/b4.webp" class="d-block w-100" alt="Image 4">
            </div>
        </div>
